<?php
	...
	$theme = simplexml_load_file ('../xml/themes/'.$nomtheme.'/'. $nomtheme.'.xml'); // on va chercher dans le fichier config le nom du theme qui est actuelement utilisé
	...
	echo(".well{ background-color:".$backcolor."; color:".$color."; font-family:".$family.";font-size:".$size.";}");
