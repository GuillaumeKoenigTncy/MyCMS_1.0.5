            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i> Mes demandes d'amis entrantes
					</div>
								...
								<?php
									...
									while($file = readdir($dir)) {
										if($file != '.' && $file != '..' ){
											...
											echo '<td  align=center><a href="scripts/scr_inputinoldfromwait.php?file='.$file.'"<button type="submit"  class="btn btn-danger delete" name="supprimer" >Supprimer</button></a></td>' ;
											echo '</tr>';
										} 
									}
								?>
