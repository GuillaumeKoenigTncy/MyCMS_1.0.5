...
<html lang="en">
	...
	<body style="background-color:#B22222">
		<div style="color:white;font-size:30px;margin-top:50px;">
			<center>
				Attention ! Vous aller lancer la procédure de ré-installation !
			</center>	
		</div>
				...
				<div class="col-md-4 col-md-offset-4">
					<div class="login-panel panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Ré-installation</h3>
						</div>
						
						<div class="panel-body">
							<div id="error"></div>	
							<form action="conf_reinstall.php">
								<fieldset>
									...
									<input type="submit" class="btn btn-lg btn-danger btn-block" value="Supprimer" id="submit">
									</fieldset>
									</form>
								</div>
						</div>
